...
async function Step1Factory(idDriver,idOrder,Products){
    ...
    try{
        ...
        for(let prod of Products){
         ...
         await RemoveRequestFactory(prod.idFactory,idOrder,prod);
         await AddWaitFactory(prod.idFactory,idOrder,prod,{id:idDriver,name:username});
